...
PanelWindow {
    ...
    Rectangle {
        ...
        // Slightly above center, Telescope-style, rather than dead-centered.
        anchors.horizontalCenter: parent.horizontalCenter
        y: (root.height - height) * 0.32
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                TextField {
                    id: searchField
                    Layout.fillWidth: true
                    placeholderText: "Search apps, files, scripts…"
                ...
                Text {
                    visible: FinderService.filesIndexing
                    text: Icons.refresh
                    color: Colors.accent
                    font.family: Theme.fontFamily
                    font.pixelSize: Theme.iconSize
                    ...
                    RotationAnimation on rotation {
                        running: FinderService.filesIndexing
